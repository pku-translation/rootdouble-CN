...
await GeneratePOs("POs", jpPackage, enPackage, projectSlug: "rootdouble_steam_cn", chunkFormatter: "source-json-chunk-{0:0000}-json--master");

var peeker = ExecutableStringPeeker.FromFile("$DataRoot/steam/executable", Utils.Cp932);
await GenerateSysPOs("POs", peeker, projectSlug: "rootdouble_steam_cn", sysFormatter: "source-json-sys-{0}-json--master");
